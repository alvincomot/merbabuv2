...
// Impor semua action dari semua slice yang dibutuhkan
import {
  fetchDestinations,
  createDestination,
  updateDestination,
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (activeTab === "wisata") dispatch(fetchDestinations());
    else if (activeTab === "users") dispatch(fetchUsers());
    else if (activeTab === "news") dispatch(fetchNews());
    else if (activeTab === "reservasi") dispatch(fetchReservasi());
  }, [dispatch, activeTab]);
  ...
  const handleWisataSubmit = async (e) => {
    ...
    const action =
      modalMode === "create"
        ...
        : updateDestination({ id: currentItem.id, formData });
  ...
  const handleUserSubmit = async (e) => {
    ...
    const action =
      modalMode === "create"
        ? createUser(userData)
        : updateUser({ id: currentItem.id, userData });
    const result = await dispatch(action);
    if (!result.error) handleCloseModal();
  };
            ...
            <nav className="-mx-3 space-y-6">
              <div className="space-y-3">
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg ${activeTab === "wisata" ? "bg-teal-600 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-700"}`}
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg ${activeTab === "reservasi" ? "bg-teal-600 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-700"}`}
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg ${activeTab === "news" ? "bg-teal-600 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-700"}`}
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg ${activeTab === "users" ? "bg-teal-600 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-700"}`}
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
            ...
            <div data-aos="fade-up">
              ...
              <div className="bg-white shadow-md rounded-lg overflow-x-auto">
                <table className="min-w-full leading-normal">
                  <thead>
                    <tr>
                      <th className="px-5 py-3 ...">Nama Wisata</th>
                  ...
                  <tbody>
                    ...
                    {destinationStatus === "succeeded" &&
                      destinations.map((dest) => (
                        <tr key={dest.id}>
                          <td className="px-5 py-5 ...">{dest.name}</td>
                          <td className="px-5 py-5 ...">{dest.location}</td>
                          <td className="px-5 py-5 ...">
                            ...
                            <button
                              onClick={() => handleWisataDelete(dest.id)}
                ...
                <table className="min-w-full leading-normal">
                  ...
                  <tbody>
                    ...
                    {newsStatus === "succeeded" &&
                      news.map((item) => (
                        <tr key={item.id}>
                          <td className="px-5 py-5 ...">{item.judul}</td>
                          <td className="px-5 py-5 ...">
            ...
            <div data-aos="fade-up">
              ...
              <div className="bg-white shadow-md rounded-lg overflow-x-auto">
                <table className="min-w-full leading-normal">
                  <thead>
                    <tr>
                      <th className="px-5 py-3 ...">Judul Layanan</th>
