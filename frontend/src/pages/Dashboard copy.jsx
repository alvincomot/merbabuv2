...
// 1. Impor Navbar dan Footer Anda
...
const Dashboard = () => {
  // --- SEMUA STATE DAN FUNGSI LOGIKA ANDA TETAP SAMA ---
  ...
  // --- SEMUA FUNGSI HANDLER ANDA (handleOpenModal, handleSubmit, dll) TETAP SAMA ---
  ...
  return (
    // 2. Pembungkus utama untuk seluruh halaman
    <div className="flex flex-col min-h-screen">
      <Navbar />

      {/* Kontainer untuk layout flex sidebar + konten utama */}
                    ...
                    {userStatus === "succeeded" &&
                      users.map((user, index) => (
                        <tr key={user.uuid}>
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <span
                              className={`px-2 py-1 font-semibold leading-tight rounded-full ${user.role === "admin" ? "text-red-900 bg-red-200" : "text-green-900 bg-green-200"}`}
                            >
                              {user.role}
                            </span>
                          </td>
      ...
      {/* Modal Universal untuk Form (Tidak berubah, tetap di luar main) */}
      {isModalOpen && (
