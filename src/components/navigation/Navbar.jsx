...
function Navbar() {
  ...
  const navLinks = [
    { to: "/", text: "Home" }, // 2. Gunakan 'to' dan path yang sesuai
          ...
          <div className="md:flex md:items-center md:gap-12">
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                {navLinks.map((link) => (
                  <li key={link.text}>
                    {/* 4. Gunakan Link dan 'to' untuk navigasi desktop */}
                    <Link
...
export default Navbar;
>>>>>>> f5691341cc0b45262a2f4a603fe588d7aedca818
