          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <button
                ...
                className="px-6 py-2.5 text-sm font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring focus:ring-teal-300 focus:ring-opacity-50 disabled:bg-teal-400"
              >
